...
{
    public partial class frmListaDoDia : Form
    {
        public frmListaDoDia()
        {
            InitializeComponent();
        ...
        private string cx = "Data Source=DANIELOLIVEIRA\\DANIELOLIVEIRA;" +
            "Initial Catalog=Temporizador; user id=sa; password=123456";
        private string sql = "";
        ...
        private void Form3_Load(object sender, EventArgs e)
        {
            ...
            sql = "select t.nome as tarefa,l.Dia,l.Tempo " +
                ...
                "on t.id = l.cod_tarefa where dia=CONVERT (DATE, SYSDATETIME())";
